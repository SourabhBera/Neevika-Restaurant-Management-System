...
class DrinksEditIngredientPage extends StatefulWidget {
  final int initialId;
  final String initialName;
  final String initialDescription;

  const DrinksEditIngredientPage({
    super.key,
  ...
  @override
  State<DrinksEditIngredientPage> createState() => _DrinksEditIngredientPageState();
}

class _DrinksEditIngredientPageState extends State<DrinksEditIngredientPage> {
