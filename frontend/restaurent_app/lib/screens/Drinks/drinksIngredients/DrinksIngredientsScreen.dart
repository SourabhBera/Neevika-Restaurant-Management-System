...
import 'package:Neevika/screens/Drinks/drinksIngredients/DrinksEditIngredientScreen.dart';
...
class DrinksIngredientScreen extends StatefulWidget {
  const DrinksIngredientScreen({super.key});

  @override
  State<DrinksIngredientScreen> createState() => _DrinksIngredientScreenState();
}

class _DrinksIngredientScreenState extends State<DrinksIngredientScreen> {
                                            ...
                                            IconButton(
                                              ...
                                              onPressed: () async {
                                                final result = await Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                    builder: (_) => DrinksEditIngredientPage(
