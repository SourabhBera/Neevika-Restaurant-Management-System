...
class AddDrinksCategoryPage extends StatefulWidget {
  const AddDrinksCategoryPage({super.key});

  @override
  _AddDrinksCategoryPageState createState() => _AddDrinksCategoryPageState();
}

class _AddDrinksCategoryPageState extends State<AddDrinksCategoryPage> {
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildLabel('Category Item Details', fontSize: 20),
