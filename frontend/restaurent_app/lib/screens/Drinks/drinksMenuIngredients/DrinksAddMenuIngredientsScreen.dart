...
class _AddMenuItemIngredientsScreenState
  ...
  final List<String> units = ['Mililiters (ml)', 'Bottle'];
  ...
  Future<void> fetchMenuItems() async {
    try {  
      ...
      final response = await http
          .get(Uri.parse('${dotenv.env['API_URL']}/drinks-menu/'),
          headers: {
  ...
  try {
    ...
    for (var ing in ingredients) {
      ...
      final response = await http.post(
        Uri.parse('${dotenv.env['API_URL']}/drinks-menu-ingredients/'),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                value: ing['unit'],
                                items: units
                                    .map((u) =>DropdownMenuItem(value: u, child: Text(u, style:
