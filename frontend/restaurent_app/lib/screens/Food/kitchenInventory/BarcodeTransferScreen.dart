...
class BarcodeTransferScreen extends StatefulWidget {
  @override
  _BarcodeTransferScreenState createState() => _BarcodeTransferScreenState();
}

class _BarcodeTransferScreenState extends State<BarcodeTransferScreen> {
  ...
  Future<void> transferItems() async {
    ...
    for (final item in scannedItems) {
      final response = await http.post(
        Uri.parse('$baseUrl/kitchen-inventory/scan-barcode-transfer'),
