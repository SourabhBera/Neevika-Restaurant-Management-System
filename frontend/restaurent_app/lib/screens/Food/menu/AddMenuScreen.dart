...
Future<void> submitMenuItem() async {
  ...
  if (name.isEmpty || priceText.isEmpty || _selectedCategoryId == null || _selectedDishType == null) {
  ...
  try {
    final response = await http.post(
      Uri.parse('${dotenv.env['API_URL']}/menu/addItem'),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildLabel('Menu Item Details', fontSize: 15),
