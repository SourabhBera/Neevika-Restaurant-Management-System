...
import 'dart:async';
import 'package:Neevika/screens/Food/menuIngredients/AddMenuIngredientsScreen.dart';
import 'package:Neevika/screens/Food/menuIngredients/EditMenuIngredientsScreen.dart';
import 'package:flutter_dotenv/flutter_dotenv.dart';
import 'package:open_file/open_file.dart';
import 'package:path_provider/path_provider.dart';
import 'package:permission_handler/permission_handler.dart';

class MenuIngredientsScreen extends StatefulWidget {
  const MenuIngredientsScreen({super.key});

  @override
  State<MenuIngredientsScreen> createState() => _MenuIngredientsScreenState();
}

class _MenuIngredientsScreenState extends State<MenuIngredientsScreen> {
  ...
  for (var item in rawList) {
    ...
    final int menuIngredientId = item['id'];
    final ingredient = {
      'id':item['id'],
      'name': item['ingredient']['itemName'],
  ...
  Future<void> fetchMenuIngredients() async {
    try {
      final response = await http
          .get(Uri.parse('${dotenv.env['API_URL']}/menu-ingredients/'))
...
Future<void> _downloadExcel() async {
  final url = Uri.parse('${dotenv.env['API_URL']}/menu-ingredients/export-excel');
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final filePath = '${dir!.path}/menu_ingredients.xlsx';
...
Future<void> _uploadExcel() async {
  ...
  final uri = Uri.parse('${dotenv.env['API_URL']}/menu-ingredients/bulk-upload');
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            Text(
              'Manage restaurant menu and its ingredients',
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  //             menuItemId : menuId,
                                  //             menuItemName: name,
                                  //             menuIngredientId: menuId,
                                  //             existingIngredients:
                                  //                 List<Map<String, dynamic>>.from(ingredients),
                                  //           ),
                                  //         ),
                                  //       );
                                  //     },
